...
export default function NavBar() {
    ...
    return (
        <>
            ...
            {/* Menu lateral */}
            <aside
                className={`fixed top-0 right-0 h-screen w-72 z-50 bg-white shadow-2xl transform transition-transform duration-300 md:hidden ${
                    menuOpen
                        ? "translate-x-0"
                        : "translate-x-full"
                }`}
            >
                ...
                <ul
                    className="flex flex-col gap-8 px-8 text-xl font-medium text-green-900 underline"
                    style={{
                        marginLeft: "15px",
                        paddingTop: "20px"
                    }}
